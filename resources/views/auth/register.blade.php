...
<div class="card max-w-lg">
    ...
    <a href="{{ route('auth.github.login') }}" class="btn btn-dark mb-2">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-6">
            <label class="label" for="password_confirmation">Підтвердження паролю</label>
            <input
    ...
    <div class="text-center mt-6">
        <span class="small">Вже є акаунт?</span>
        <a href="{{ route('login') }}" class="link ml-1">Увійти</a>
    </div>
</div>
</body>
</html>
