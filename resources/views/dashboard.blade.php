...
<div class="card max-w-3xl">
    ...
    <div class="flex pb-4">
        @if(!Auth::user()->github_id)
            <a href="{{ route('auth.github') }}" class="btn btn-dark inline-flex items-center gap-2">
    ...
    <div class="flex gap-3 flex-wrap mt-4 flex-col">
        <a href="{{ route('admin.login-attempts') }}" class="btn" style="width:auto">📊 Логи входу</a>
